...
VALUES (NULL, 'Segadeira', 'Utilizada para cortar grama, cereais e capim – esse último transformado em feno para alimentação animal.', 'MAQUINA', '360000', '2014-10-01','EM_POSSE', NULL, NULL, NULL, 10),
	   ...
	   (NULL, 'Enfardadora', 'Produz fardos de feno cilindricos.', 'MAQUINA', '175000', '2018-07-07','VENDIDO', NULL, NULL, '2018-09-30', 2.5),
           (NULL, 'Enleirador de café', 'Cata grãos espalhados pelo solo.', 'MAQUINA', '93000', '2017-05-29','EM_POSSE', NULL, NULL, NULL, 2),
	   (NULL, 'Trator Massey Ferguson 290', 'Uma maquina versátil e de fácil adaptação para trabalhos diversos.', 'MAQUINA', '30996', '1989-02-23','VENDIDO', NULL, NULL, '2015-09-07', 1.5),
           (NULL, 'Trator D6k Caterpillar', 'Uma maquina versátil e de fácil adaptação para trabalhos diversos.', 'MAQUINA', '93000', '2015-08-12','EM_POSSE', NULL, NULL, NULL, 5);
-- Tabela Tarefa
