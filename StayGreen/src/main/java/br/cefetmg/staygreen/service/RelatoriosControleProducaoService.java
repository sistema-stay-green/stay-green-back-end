...
public class RelatoriosControleProducaoService {
    ...
    public static ArrayList<String> relatorio2() {
        ...
        producaoTotal.add("LEITE:" + producaoIndividual.get(0));
        producaoTotal.add("CAFE_ROBUSTA:" + producaoIndividual.get(1));
        producaoTotal.add("CAFE_BOURBON:" + producaoIndividual.get(2));
        producaoTotal.add("CAFE_ARABICA:" + producaoIndividual.get(3));
