...
public class Venda {
     ...
     */
    public Venda(Long id, String produto, String tipo, double entradaSaida, double valor, Calendar dataTransacao) {
        this.id = id;
    ...
    public double getValorTotal(){
        return TransacaoService.calculaValorTotal(valor, entradaSaida, tipo);
    }
